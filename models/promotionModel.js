// Modello per le promozioni, con campi id, name, selling_price, purchase_price, onSale, insertedBy, updatedBy, updatedAt
...
const Promotion = sequelize.define('Promotion', {
  ...
  validate: {
    async uniqueName() {
      ...
      const existing = await Promotion.findOne({ where: condition });
      if (existing) {
        throw new Error('Esiste già una promozione con questo nome.');
      }
    },
  },
});
